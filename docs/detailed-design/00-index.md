...
| 配置 | 默认值 | 说明 |
|---|---:|---|
| detailedDesignFiles | 19 | 含本索引和 18 个专题。 |
| firstMilestoneDays | 7 | 第一版只做可靠单 Agent。 |
| firstMilestoneTools | 6 | 第一版工具列表：Read、Grep、Glob、Bash、Edit、Write。 |
| minimumReplayCases | 12 | 覆盖主循环、工具、权限、上下文、恢复。 |
